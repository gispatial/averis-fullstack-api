        ...
        <CardBody>
          <ul className="activity-timeline timeline-left list-unstyled">
            <li>
              ...
              <div className="timeline-info">
                ...
                <span className="font-small-3">
                  Bought apple iPhone 12 Pro Max today!
                </span>
              </div>
            ...
            <li>
              ...
              <div className="timeline-info">
                <p className="font-weight-bold mb-0">Plan Averis Webinar</p>
                <span className="font-small-3">
            ...
            <li>
              ...
              <div className="timeline-info">
                <p className="font-weight-bold mb-0">Launch Averis New eLearning System</p>
